...
const contacts = [
  ...
  // EPPC
  { name: "Clare Morell", org: "EPPC", title: "Fellow, Technology & Human Flourishing", contact_type: "advocacy", twitter_handle: "ClareMorellEPPC", linkedin_url: "https://linkedin.com/in/clare-morell-2903a980/", relevance_score: 89, priority_tier: 1, tags: ["think-tank", "priority-1", "kosa", "parental-controls"], notes: "Policy directly adopted into Utah state law. Leads EPPC Technology & Human Flourishing program." },
  { name: "Adam Candeub", org: "EPPC", title: "Director, Internet Accountability Project", contact_type: "advocacy", relevance_score: 60, priority_tier: 3, tags: ["think-tank"], notes: "Co-convened working group w/ Morell, Twenge, Wilcox." },
  ...
  // AEI
  { name: "Shane Tews", org: "American Enterprise Institute", title: "Nonresident Sr. Fellow", contact_type: "advocacy", twitter_handle: "ShaneTews", linkedin_url: "https://linkedin.com/in/shane-tews-b20230/", relevance_score: 70, priority_tier: 1, tags: ["think-tank", "priority-1", "parental-controls"], notes: "Authored 'Protecting Youth Online: A Guide to Parental Controls.' Advocates app-level responsibility." },

  // Heritage Foundation
  { name: "Kara Frederick", org: "Heritage Foundation", title: "Director (fmr), Tech Policy Center", contact_type: "advocacy", twitter_handle: "karaafrederick", linkedin_url: "https://linkedin.com/in/kara-frederick-965a33129/", relevance_score: 85, priority_tier: 2, tags: ["think-tank", "kosa", "coppa"], notes: "Former Facebook team lead & DoD counterterrorism analyst. Led Heritage advocacy for KOSA/COPPA 2.0." },
  { name: "Daniel Cochrane", org: "Heritage Foundation", title: "Sr. Research Associate, Center for Technology & Human Person", contact_type: "advocacy", twitter_handle: "RealDCochrane", linkedin_url: "https://linkedin.com/in/daniel-evan-cochrane", relevance_score: 85, priority_tier: 1, tags: ["think-tank", "priority-1", "platform-accountability"], notes: "Testified before House on data privacy & kids on social media." },

  // R Street
  { name: "Shoshana Weissmann", org: "Abundance Institute (fmr R Street)", title: "Policy Advisor", contact_type: "advocacy", twitter_handle: "senatorshoshana", email: "scweissmann@gmail.com", relevance_score: 35, priority_tier: 3, tags: ["think-tank", "free-expression", "skeptic"], notes: "Critic of KOSA from free-expression angle. Low engagement likelihood but bipartisan signal." },

  // BPC
  { name: "Marilyn Serafini", org: "Bipartisan Policy Center", title: "Executive Director", contact_type: "advocacy", twitter_handle: "marilynserafini", relevance_score: 71, priority_tier: 3, tags: ["think-tank", "bipartisan"], notes: "Leads BPC tech & health program." },
  { name: "Gabriel Loud", org: "Bipartisan Policy Center", title: "Technology Program contact", contact_type: "advocacy", email: "gloud@bipartisanpolicy.org", relevance_score: 71, priority_tier: 3, tags: ["think-tank", "bipartisan"], notes: "Point of contact for BPC technology program." },
  ...
  // FPF
  { name: "Jules Polonetsky", org: "Future of Privacy Forum", title: "CEO", contact_type: "advocacy", email: "julespol@fpf.org", linkedin_url: "https://linkedin.com/in/julespolonetsky/", relevance_score: 74, priority_tier: 2, tags: ["think-tank", "privacy"], notes: "Former AOL Chief Privacy Officer, former NYC Council member." },
  { name: "Bailey Sanchez", org: "Future of Privacy Forum", title: "Sr. Counsel, Youth & Education Privacy", contact_type: "advocacy", linkedin_url: "https://linkedin.com/in/baileysanchez/", relevance_score: 70, priority_tier: 3, tags: ["think-tank", "coppa", "aadc"], notes: "Published FPF's COPPA 2.0 redline. Tracks state AADC adoption." },
