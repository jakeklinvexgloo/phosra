...
const SOCIAL_LINKS = [
  ...
  { label: "X", href: "https://x.com/phosra", icon: XIcon },
  { label: "LinkedIn", href: "https://linkedin.com/company/phosra", icon: LinkedInIcon },
]
...
export function Footer() {
  return (
    <footer className="relative overflow-hidden bg-gradient-to-b from-[#0D1B2A] to-[#060D16] text-white">
      ...
      <div className="h-px bg-gradient-to-r from-transparent via-brand-green/20 to-transparent" />
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/[0.05] border border-white/[0.08]">
              ...
              <span className="text-[11px] text-white/40">{PLATFORM_STATS.liveCount}+ live platforms</span>
            </div>
          </div>
