...
const STATS = [
  ...
  { value: 15, suffix: "+", label: "Platform adapters", description: "And growing — connect any service" },
  { value: 5, suffix: "", label: "Rating systems", description: "MPAA, TV, ESRB, PEGI, CSM — mapped automatically" },
  { value: 11, suffix: "+", label: "Compliance laws", description: "KOSA, COPPA 2.0, EU DSA, and more" },
]
