...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    category: "feature",
    description: "Initial public release of Phosra (formerly GuardianGate). Open child safety spec and API covering 229+ platforms in the kids' ecosystem, 45 policy categories, and 5 age-rating systems.",
    highlights: [
