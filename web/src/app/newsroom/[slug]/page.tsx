      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-8 py-12 sm:py-16">
        ...
        <AnimatedSection className="mt-16 pt-10 border-t border-border">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Phosra is an open child safety spec and API. Kids use 229+ apps and platforms {"\u2014"} each with different, fragmented parental controls. Phosra defines a universal spec so platforms can offer interoperable controls and parents can set rules once. We track 78 child safety laws across 25+ jurisdictions. Learn more at{" "}
