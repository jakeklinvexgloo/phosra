...
export async function POST(req: NextRequest) {
  ...
  const { name, publication, title, beat, sub_beats, email, twitter_handle, linkedin_url, signal_handle, phone, relevance_score, tier, relationship_status, pitch_angles, recent_articles, coverage_preferences, notes } = body
  ...
  const journalist = await query<Journalist>(
    `INSERT INTO admin_journalists(name, publication, title, beat, sub_beats, email, twitter_handle, linkedin_url, signal_handle, phone, relevance_score, tier, relationship_status, pitch_angles, recent_articles, coverage_preferences, notes)
     VALUES ($1, $2, $3, $4, $5::text[], $6, $7, $8, $9, $10, $11, $12, $13, $14::jsonb, $15::jsonb, $16::jsonb, $17)
     RETURNING *`,
    [
      name.trim(),
      publication.trim(),
