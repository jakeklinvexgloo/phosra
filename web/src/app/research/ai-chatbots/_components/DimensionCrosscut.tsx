    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-10">
        ...
        <div className="flex items-center justify-between mt-12 pt-6 border-t border-border">
          {prev ? (
            <Link
              href={`/research/ai-chatbots/dimensions/${prev.id}`}
          ...
          {next ? (
            <Link
              href={`/research/ai-chatbots/dimensions/${next.id}`}
              className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors"
            >
              Next: {next.title}
            ...
            return (
              <tr key={p.platformId} className="hover:bg-muted/20 transition-colors">
                <td className="sticky left-0 z-10 bg-background px-4 py-3 font-medium text-foreground">
                  <Link href={`/research/ai-chatbots/${p.platformId}`} className="hover:text-brand-green transition-colors">
                    {p.platformName}
                  </Link>
                </td>
