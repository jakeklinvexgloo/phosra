...
const COMPARISON = [
  ...
  { feature: "Policy categories", family: "45", developer: "45", enterprise: "45 + custom" },
  { feature: "Platform integrations", family: "3", developer: "Unlimited", enterprise: "Unlimited" },
  { feature: "Community Standards", family: "\u2713", developer: "\u2713", enterprise: "\u2713 + custom" },
...
export default function PricingPage() {
  ...
  return (
    <div>
      ...
      {/* Pricing cards */}
      <div className="max-w-5xl mx-auto px-4 sm:px-8 grid lg:grid-cols-3 gap-6 mb-20">
        {TIERS.map((tier) => (
          <div
            key={tier.name}
