...
export default function PlatformsPage() {
  ...
  return (
    <div>
      {/* Hero header */}
      <div className="mb-10">
        <h1 className="text-3xl sm:text-4xl font-display text-foreground mb-3">Platform Coverage Explorer</h1>
        <p className="text-muted-foreground text-lg max-w-2xl mb-4">
          Explore the platforms Phosra supports across DNS filtering, streaming, gaming, device management, and browser extensions.
        </p>
